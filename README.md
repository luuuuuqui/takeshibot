...
2. [⚠️ Atenção - Suporte](#-atenção)
3. [📖 Sobre o Projeto](#sobre-este-projeto)
4. [🚀 Instalação](#instalação-no-termux)
    - [Instalação no Termux](#instalação-no-termux)
    - [Instalação em Hosts](#instalação-nas-principais-hosts-do-brasil)
    - [Instalação em VPS](#instalação-em-vps-debianubuntu)
5. [📊 Diagrama de Conexão](#diagrama-de-conexão)
6. [⚙️ Configuração de API](#alguns-comandos-necessitam-de-api)
...
9. [📊 Diagramas de Funcionamento](#diagrama-de-como-os-comandos-funcionam)
    - [Fluxo de Comandos](#diagrama-de-como-os-comandos-funcionam)
    - [Middlewares (Interceptadores)](#diagrama-de-como-funcionam-os-middlewares-interceptadores-de-recepção-e-saída)
10. [💻 Desenvolvimento Técnico](#custom-middleware---personalize-o-bot-sem-modificar-arquivos-principais)
    - [Custom Middleware](#custom-middleware---personalize-o-bot-sem-modificar-arquivos-principais)
    - [Implementação dos Exemplos](#implementação-técnica-dos-exemplos)
11. [📁 Estrutura de Pastas](#estrutura-de-pastas)
12. [🔄 Manutenção e Testes](#atualizar-o-bot)
13. [❓ Erros Comuns](#erros-comuns)
14. [📺 Canal do YouTube](#inscreva-se-no-canal)
15. [🤝 Contribuição e Licença](#contribuindo-com-o-projeto)
    - [Como Contribuir](#contribuindo-com-o-projeto)
    - [Licença (GPL-3.0)](#licença)
