...
- [🌐 Idiomas Disponíveis](#-acesse-o-takeshi-bot-em-outros-idiomas)
- [⚠️ Atenção & Suporte](#-atenção)
- [📖 Sobre o Projeto](#sobre-este-projeto)
- [🚀 Guia de Instalação](#instalação-no-termux)
  - [Termux (Android)](#instalação-no-termux)
    - [Hospedagem (Hosts Recomendadas)](#instalação-nas-principais-hosts-do-brasil)
    - [VPS (Debian/Ubuntu)](#instalação-em-vps-debianubuntu)
- [⚙️ Configurações](#alguns-comandos-necessitam-de-api)
  - [Configurar APIs Externas](#alguns-comandos-necessitam-de-api)
  - [Auto Responder](#auto-responder)
  - [Personalização (Menu e Mensagens)](#onde-fica-o-menu-do-bot)
- [🛠️ Funcionalidades](#funcionalidades-gerais)
  - [Lista Geral de Comandos](#funcionalidades-gerais)
  - [Exemplos de Envio](#funcionalidades-de-envio-exemplos)
- [📊 Diagramas de Fluxo](#diagrama-de-conexão)
- [💻 Desenvolvimento & Técnico](#custom-middleware---personalize-o-bot-sem-modificar-arquivos-principais)
  - [Custom Middlewares](#custom-middleware---personalize-o-bot-sem-modificar-arquivos-principais)
  - [Implementação de Comandos](#implementação-técnica-dos-exemplos)
  - [Estrutura de Pastas](#estrutura-de-pastas)
- [❓ Ajuda e Comunidade](#erros-comuns)
  - [Erros Comuns](#erros-comuns)
  - [Como Contribuir](#contribuindo-com-o-projeto)
  - [Licença e Disclaimer](#licença)
